      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              className='text-4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto text-gray-900 dark:text-gray-100'>
